...
export default function SellerNavbar({onSetValue, setPage, user}){
    let btnStyle = {  };
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav">
                                ...
                                <a className="nav-link" href="#" onClick={ (e) =>  {onSetValue ("makanan"); setPage("home")}} style={btnStyle}>Order</a>
                                </li>
                                <li className="nav-item">
                                <a className="nav-link" href="#" onClick={(e) => {onSetValue ("minuman"); setPage("home")}} style={btnStyle}>Items</a> 
                                </li>
                                <li className="nav-item">
                                <a className="nav-link" href="#" onClick={(e) => {onSetValue ("electronic"); setPage("home")}} style={btnStyle}>Upload Item</a>
                                </li>
                                <li className="nav-item">
                                <a className="nav-link" href="#" onClick={(e) => {onSetValue ("tools"); setPage("home")}} style={btnStyle}>Profile</a>
                                </li>
                            </ul>
